...
public class ClassesNameAdapter extends RecyclerView.Adapter<ClassesNameAdapter.ClassViewHolder> {

    private ClassViewHolder.OnClassSelectListener mListener;
    private final List<String> mClassesName = new ArrayList<>();

    public ClassesNameAdapter(ClassViewHolder.OnClassSelectListener listener) {
        mListener = listener;
    }
